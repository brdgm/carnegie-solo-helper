<template>
  ...
  <ModalDialog id="creditsModal" :title="t('footer.credits')">
    <template #body>
      <h4><a href="https://boardgamegeek.com/boardgame/310873/carnegie" target="_blank" rel="noopener">{{t('gameTitle')}}</a></h4>
      <dl>
        <dt>Game design</dt>
        <dd>Xavier Georges</dd>
        <dt>Graphics design</dt>
        <dd> Ian O'Toole</dd>
        <dt>Publisher</dt>
        <dd><a href="https://www.quined.nl/" target="_blank" rel="noopener">Quined Games</a></dd>
      </dl>
      ...
      <dl>
        ...
        <dt>Version</dt>
        <dd>{{buildNumber}} (<a href="https://github.com/brdgm/carnegie-solo-helper/releases" target="_blank" rel="noopener">Change Log</a>)</dd>
        <dt>Source Code (Apache-2.0 License)</dt>
        <dd><a href="https://github.com/brdgm/carnegie-solo-helper" target="_blank" rel="noopener">https://github.com/brdgm/carnegie-solo-helper</a></dd>
      </dl>
